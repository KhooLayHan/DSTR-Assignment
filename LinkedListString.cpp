...
//     void LinkedList::InsertBegin(const DataVariant& data) {
...
//     void LinkedList::InsertEnd(const DataVariant& data) {
...
//     void LinkedList::InsertPosition(const DataVariant& data, size_t position) {
//         LinkedListNode* node = new LinkedListNode(data);
//         // LinkedListNode* node = new LinkedListNode(std::move(data));
...
//     void LinkedList::DeleteNode(const DataVariant& dataset) {
//         if (m_Head == nullptr) {
